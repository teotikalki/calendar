...
public class JCRDataStorage implements DataStorage {
  ...
  public Map<Integer, String> searchHighlightRecurrenceEvent(String username,
    ...
    java.util.Calendar tempCalendar = java.util.Calendar.getInstance(CommonsUtils.getTimeZone(timezone));
  ...
  public Map<String, CalendarEvent> getOccurrenceEvents(CalendarEvent recurEvent,
    ...
    TimeZone userTimeZone = CommonsUtils.getTimeZone(timezone);
    ...
    net.fortuna.ical4j.model.TimeZone tz = Utils.getICalTimeZone(CommonsUtils.getTimeZone(timezone));
  ...
  public Collection<CalendarEvent> buildSeriesByTime(CalendarEvent recurEvent,
    ...
    try {
      tz = Utils.getICalTimeZone(CommonsUtils.getTimeZone(timezone));
